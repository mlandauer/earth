...
//
// $Id: ImageSeqMon.h,v 1.1 2003/02/03 05:08:11 mlandauer Exp $

#ifndef _SP_IMAGE_SEQ_MON_H_
#define _SP_IMAGE_SEQ_MON_H_
...
class ImageSeqMon : public ImageEventObserver
{
public:
