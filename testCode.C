...
void testSpFile()
{
	SpFile file(SpPath("/home/matthew/images/blah1.tiff"));
	...
	SpFile f;
	cout << "setPath..." << endl;
	f.setPath(SpPath("/home/matthew/images/blah1.tiff"));
	cout << "open..." << endl;
	f.open();
	cout << "setPath..." << endl;
	f.setPath(SpPath("/home/matthew/images/blah1.tiff"));
...
void testSpImage()
{
	SpImage *image1 = SpImage::construct(SpPath("/home/matthew/images/dibble1.sgi"));
	if (image1 != NULL) {
	...
	SpImage *image2 = SpImage::construct(SpPath("/home/matthew/images/blah1.tiff"));
	if (image2 != NULL) {
	...
	SpImage *image3 = SpImage::construct(SpPath("/home/matthew/images/foo1.gif"));
	if (image3 != NULL) {
...
void testSpFsObject()
{
	...
	SpFsObject file(SpPath("/home/matthew/images/blah1.tiff"));
	...
	SpFsObject file2(SpPath("/home/matthew/images/"));
...
void testSpDir()
{
	...
	SpDir dir(SpPath("/home/matthew/images/"));
