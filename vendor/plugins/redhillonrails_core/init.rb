# why why why?! 
# Under test, the plugin seems to be included twice, meaning that ActiveRecord::SchemaDumper#tables (for example) is double method-chained
# This inevitably reults in a recursive infinite loop.
